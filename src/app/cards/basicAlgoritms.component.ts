...
export function third() {
  ...
  switch (option) {
    ...
    case 2:
      var amount = Number(
        prompt('Ingresa la cantidad de numeros que deseas sumar')
      );
  ...
  switch (option) {
    ...
    case 2:
      ...
      while (isNaN(amount)) {
        alert('Solo es posible ingresar numeros');
        amount = Number(
          prompt('Ingresa la cantidad de numeros que deseas restar')
        );
      }
...
export function fifth() {
  var option = Number(
    prompt('1. Multiplicar dos numeros \n 2. Multiplicacion personalizada')
  );
  ...
  switch (option) {
    case 1:
      ...
      alert(
        'La multiplicacion de los dos numeros ingresados es: ' + multiplication
      );
      break;
    ...
    case 2:
      ...
      alert(
        'La multiplicacion de los dos numeros ingresados es ' +
...
export function seventh() {
  var base = Number(
    prompt('Ingresa la medida de la base del rectangulo en centimetros')
  );
  var height = Number(
    prompt('Ingresa la medida de la altura del rectangulo en centimetros')
  );
  ...
  while (isNaN(base) || isNaN(height) || base <= 0 || height <= 0) {
    ...
    height = Number(
      prompt('Ingresa la medida de la altura del rectangulo centimetros')
    );
  }
  ...
  var option = confirm(
    '¿Desea visualizar la longitud del area del rectangulo en metros tambien?'
  );

  if (option == true) {
    var areaMeter = area / 100;
...
export function eighth() {
  var side = Number(
    prompt('Ingrese una de las medidas del lado del cuadrado en centimetros')
  );
...
export function tenth() {
  var celsius = Number(
    prompt(
      'Ingrese la cantidad de grados Celsius a convertir en grados Fahrenheit'
    )
  );
  ...
  while (isNaN(celsius)) {
    alert('Solo se pueden ingresar numeros');
    celsius = Number(
      prompt('Ingrese la cantidad de grados Celsius a convertir en Fahrenheit')
    );
  }
...
export function sixteenth() {
    ...
    //     let word = prompt("Ingrese palabras o numeros");
